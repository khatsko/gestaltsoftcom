        ...
        <div class="product-details">
          ...
          <div class="content">
            <ul class="nav nav-pills  justify-content-center" id="pills-tab" role="tablist">
              ...
              <li class="nav-item">
                <a class="nav-link active" id="pills-contact-tab" data-toggle="pill" href="/gestalt-keylogger/download/" role="tab" aria-controls="pills-contact" aria-selected="false">Download</a>
              </li>
              <li class="nav-item">
            ...
            <div class="tab-content" id="pills-tabContent">
              <div class="tab-pane fade show active" id="pills-home" role="tabpanel" aria-labelledby="pills-home-tab">
                ...
                <h3 class="tab-title">Download Gestalt KeyLogger</h3>

<p>
<b>Gestalt KeyLogger</b> is designed to record all the keys pressed on the keyboard on the computer. Records all keys, time of pressing and names of applications in which these keys were pressed. It also records the time the computer is turned on and off. Simple, convenient, modern and user-friendly interface. This program is the best solution to find out what they are doing at your computer while you are away.
</p>

<p>
<strong>Latest version:</strong> <span style="color: #59d659;">1.0.0</span>
<br />
<strong>Released on</strong> <span style="color: #59d659;">March 25, 2020</span>
</p>

<br />
<div class="widget price text-center">
  <a href="/gestalt-keylogger/files/GestaltKeyLoggerSetup.exe" style="font-size: 24px; font-weight: bold; color: #fff;">Download Gestalt KeyLogger (7.4 Mb)</a>
</div>
